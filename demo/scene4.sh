...
# ============================================================================
# Standalone scene 4, for a market that already holds scenes 1 to 3 (sales 0..2
# on claim 0). Same captions, dwell, focus and waits as scenes.sh; only the
# earlier scenes are skipped. Run with --allow-existing.
# ============================================================================
CLAIM_A=0; S1=0; S2=1; S3=2
...
caption 4 "Scene 4 · A silent buyer. Three sales are already on-chain from the earlier scenes: confirmed, refuted, refuted. Now a second claim, a wallet with no history, and a buyer that never adjudicates." "addr:$SELLER_ADDR"
...
sleep 6
log "scene 4 done: sale #$S4 on claim #$CLAIM_B"
